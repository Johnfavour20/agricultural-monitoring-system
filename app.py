...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL',
                                                       'mysql://root:@localhost/smart_farm_db')
...
class User(db.Model):
    ...
    farm_type = db.Column(db.Enum('crop', 'greenhouse', 'livestock', 'mixed', 'organic'),
                           nullable=False)
    ...
    subscription_type = db.Column(db.Enum('free', 'basic', 'premium', 'enterprise'),
                                   default='free')
...
class Device(db.Model):
    ...
    device_type = db.Column(db.Enum('esp32', 'arduino', 'raspberry_pi', 'custom'),
                             default='esp32')
...
class Order(db.Model):
    ...
    order_type = db.Column(db.Enum('starter_kit', 'professional_kit', 'enterprise_kit', 'custom',
                                   'individual_component'), nullable=False)
    ...
    payment_method = db.Column(db.Enum('bank_transfer', 'card', 'mobile_money',
                                       'cash_on_delivery'), default='bank_transfer')
...
if __name__ == '__main__':
    ...
    # Add this temporarily at the very end of your app.py file
